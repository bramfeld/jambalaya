/*
 * Copied from the "Table Sorter Demo" example in the Java Tutorial
 ...
 * getValueAt(row, column) it redirects them to its model via the mapping
...
public class TableSorter extends TableMap {
    ...
    public void checkModel() {
        if (indexes.length != model.getRowCount()) {
            //(new Exception ("Sorter not informed of a change in model.")).printStackTrace(); //TODO find out why this happens
        }
    }
    ...
    public void setValueAt(Object aValue, int aRow, int aColumn) {
        checkModel();
        // it is possible that the indexes are out of date, this happens when a
        // button inside the table is clicked and removes a row from this model
        if (aRow < indexes.length) {
