...
public class GradientPanel extends JPanel {
	...
	public static void main(String[] args) {
		...
		dlg.setPreferredSize(new Dimension(300, 300));
		dlg.setModal(true);
		dlg.setLocation(400, 200);

		dlg.getContentPane().setLayout(new GridLayout(2, 2, 4, 4));
		dlg.getContentPane().setBackground(Color.black);
		dlg.getContentPane().add(new GradientPanel(Color.white, Color.blue, TOP_TO_BOTTOM));
		dlg.getContentPane().add(new GradientPanel(Color.white, Color.blue, LEFT_TO_RIGHT));
		dlg.getContentPane().add(new GradientPanel(Color.white, Color.blue, TOP_LEFT_TO_BOTTOM_RIGHT));
		dlg.getContentPane().add(new GradientPanel(Color.white, Color.blue, BOTTOM_LEFT_TO_TOP_RIGHT));
		dlg.setVisible(true);
		System.exit(0);
	}
