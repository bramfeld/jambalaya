 ...
 * @author Rob Lintern
 */
public class CurvedDottedLineArcStyle extends CurvedLineArcStyle {

	public final static String NAME = "Dotted Line - Curved";

	public CurvedDottedLineArcStyle() {
		super(NAME, true);
	}
	 ...
	 */
	public Object clone() {
		return new CurvedDottedLineArcStyle();
	}
	...
	public JComponent getThumbnail(final Color arcColor) {
		JPanel panel = new JPanel() {
			public void paint(Graphics g) {
				...
				g2.setStroke(new BasicStroke (2.0f, BasicStroke.CAP_SQUARE, BasicStroke.JOIN_MITER, 10.0f, dash, 0.0f));
				g2.draw (curve);
			}
		};
