 ...
 */
public class SwingToolTipManager extends MouseAdapter implements MouseMotionListener {
	...
	final static SwingToolTipManager sharedInstance = new SwingToolTipManager();
	 ...
	 */
	public static SwingToolTipManager sharedInstance() {
